...
# bytecode =''
...
# abi = [{'constant': True, 'inputs': [{'internalType': 'address', 'name': 'a', 'type': 'address'}], 'name': 'setAddrArray', 'outputs': [{'internalType': 'address', 'name': '', 'type': 'address'}], 'payable': False, 'stateMutability': 'pure', 'type': 'function'}]
...
print('Get Address : {}'.format(
    payable.functions.setAddrArray(address).call()
))
